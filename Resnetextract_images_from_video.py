...
for file in files:
   ...
   writen_frames=0
   #pdb.set_trace()
   directoryTrain = '../Kinetics/kinetics-dataset/k400imagesRes50/train/'+file.split('/')[-1].split('.')[0].split('_')[0]
   directoryVal = '../Kinetics/kinetics-dataset/k400imagesRes50/val/'+file.split('/')[-1].split('.')[0].split('_')[0]
